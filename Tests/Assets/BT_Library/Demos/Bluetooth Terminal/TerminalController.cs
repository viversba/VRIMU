...
////
////			byte [] msg = device.read (); //// ////			if (msg != null) { //// ////				//converting byte array to string. ////				string content = System.Text.ASCIIEncoding.ASCII.GetString (msg); //// ////				//here we split the string into lines. '\n','\r' are charachter used to represent new line. //////				string [] lines = content.Split(new char[]{'\n','\r'}); //// ////				//Add those lines to the scrollText
//////				text = content; ////				readDataText.set (content); //// ////				/* Note: You should notice the possiblity that at the time of calling read() a whole line has not yet completly recieved.
////					 * This will split a line into two or more lines between consecutive read() calls. This is not hard to fix, but the goal here is to keep the code simple.
////					 * To see a solution using methods of this library check out the "High Bit Rate demo". 
////					 */ ////			}
////			yield return null;
